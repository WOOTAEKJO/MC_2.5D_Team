...
{
private:
	explicit CMageSoldier(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit CMageSoldier(const CMageSoldier& rhs);
	virtual ~CMageSoldier();
...
public:
	static CMageSoldier* Create(LPDIRECT3DDEVICE9 pGraphicDev);
