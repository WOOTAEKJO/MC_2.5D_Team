...
{
private:
	explicit CSwordMaster(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit CSwordMaster(const CSwordMaster& rhs);
	virtual ~CSwordMaster();
...
public:
	static CSwordMaster* Create(LPDIRECT3DDEVICE9 pGraphicDev);
